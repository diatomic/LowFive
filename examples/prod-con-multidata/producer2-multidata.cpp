                 ...
                 int global_nblocks, int dim, size_t local_num_points)
{
    if (intercomms.size() == 2)
        fmt::print("producer2: shared {} local size {} intercomms size {} intercomm1 size {} intercomm2 size {}\n",
                shared, local.size(), intercomms.size(), intercomms[0].size(), intercomms[1].size());
    else
        fmt::print("producer2: shared {} local size {} intercomms size {} intercomm1 size {}\n",
