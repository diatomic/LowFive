...
//     NULL,
//     {
//         NULL, //H5VL_log_attr_create,
//         NULL, //H5VL_log_attr_open,
//         NULL, //H5VL_log_attr_read,
//         NULL, //H5VL_log_attr_write,
//         NULL, //H5VL_log_attr_get,
//         NULL, //H5VL_log_attr_specific,
//         NULL, //H5VL_log_attr_optional,
//         NULL //H5VL_log_attr_close
//     },
//     {
...
//         NULL, //H5VL_log_dataset_get,
//         NULL, //H5VL_log_dataset_specific,
//         NULL, //H5VL_log_dataset_optional,
//         H5VL_log_dataset_close
//     },
//     {
//         H5VL_log_datatype_commit,
//         H5VL_log_datatype_open,
//         H5VL_log_datatype_get,
//         NULL, //H5VL_log_datatype_specific,
//         NULL, //H5VL_log_datatype_optional,
//         H5VL_log_datatype_close
//     },
//     {
//         H5VL_log_file_create,
//         H5VL_log_file_open,
//         H5VL_log_file_get,
//         NULL, //H5VL_log_file_specific,
//         NULL, //H5VL_log_file_optional,
//         H5VL_log_file_close
//     },
//     {
//         H5VL_log_group_create,
//         NULL, //H5VL_log_group_open,
//         NULL, //H5VL_log_group_get,
//         NULL, //H5VL_log_group_specific,
//         NULL, //H5VL_log_group_optional,
//         H5VL_log_group_close
//     },
//     {
//         NULL, //H5VL_log_link_create,
//         NULL, //H5VL_log_link_copy,
//         NULL, //H5VL_log_link_move,
//         NULL, //H5VL_log_link_get,
//         NULL, //H5VL_log_link_specific,
//         NULL, //H5VL_log_link_optional,
//     },
//     {
//         H5VL_log_object_open,
//         NULL, //H5VL_log_object_copy,
//         NULL, //H5VL_log_object_get,
//         H5VL_log_object_specific,
//         NULL, //H5VL_log_object_optional,
//     },
//     {
//         NULL,
//         NULL,
...
visit_cb(hid_t oid, const char *name, const H5O_info_t *oinfo, void *udata)
{
    ...
    // TODO: H5VLget_plugin_name undeclared, trying H5VLget_connector_name instead
...
H5VL_log_file_create(const char *name, unsigned flags, hid_t fcpl_id, hid_t fapl_id, hid_t dxpl_id, void **req)
{
    ...
    // TODO: H5Pget_vol_info missing second argument to void **vol_info
        ...
        hid_t gcpl_id, hid_t gapl_id, hid_t dxpl_id, void **req)
{
    ...
    // TODO: following missing lcpl argument
//     group->under_object = H5VLgroup_create(o->under_object, loc_params, native_plugin_id, name,
...
static void *
H5VL_log_datatype_open(void *obj, H5VL_loc_params_t loc_params, const char *name, hid_t tapl_id,
        hid_t dxpl_id, void **req)
{
    ...
    dt->under_object = H5VLdatatype_open(o->under_object, &loc_params, native_plugin_id, name,
            tapl_id, dxpl_id, req);
...
static herr_t
H5VL_log_object_specific(void *obj, H5VL_loc_params_t loc_params, H5VL_object_specific_t
...
H5VL_log_dataset_create(void *obj, H5VL_loc_params_t loc_params, const char *name, hid_t dcpl_id, hid_t dapl_id, hid_t dxpl_id, void **req)
{
    ...
    // TODO H5VLdataset_create() requires 11 args but 8 were provided
//     dset->under_object = H5VLdataset_create(o->under_object, loc_params, native_plugin_id, name,
...
static void *
H5VL_log_dataset_open(void *obj, H5VL_loc_params_t loc_params, const char *name, hid_t dapl_id,
        hid_t dxpl_id, void **req)
{
    H5VL_log_t *dset;
    H5VL_log_t *o = (H5VL_log_t *)obj;
