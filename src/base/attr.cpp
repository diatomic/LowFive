...
attr_create(void *obj, const H5VL_loc_params_t *loc_params,
    ...
    hid_t aapl_id, hid_t dxpl_id, void **req)
{
    return wrap(H5VLattr_create(unwrap(obj), loc_params, info->under_vol_id, name, type_id, space_id, acpl_id, aapl_id, dxpl_id, req));
}
...
attr_open(void *obj, const H5VL_loc_params_t *loc_params,
    const char *name, hid_t aapl_id, hid_t dxpl_id, void **req)
{
    return wrap(H5VLattr_open(unwrap(obj), loc_params, info->under_vol_id, name, aapl_id, dxpl_id, req));
}
...
attr_read(void *attr, hid_t mem_type_id, void *buf,
    hid_t dxpl_id, void **req)
{
    return H5VLattr_read(unwrap(attr), info->under_vol_id, mem_type_id, buf, dxpl_id, req);
}
...
attr_write(void *attr, hid_t mem_type_id, const void *buf,
    hid_t dxpl_id, void **req)
{
    return H5VLattr_write(unwrap(attr), info->under_vol_id, mem_type_id, buf, dxpl_id, req);
}
...
attr_get(void *obj, H5VL_attr_get_t get_type, hid_t dxpl_id,
    void **req, va_list arguments)
{
    return H5VLattr_get(unwrap(obj), info->under_vol_id, get_type, dxpl_id, req, arguments);
}
...
attr_specific(void *obj, const H5VL_loc_params_t *loc_params,
    H5VL_attr_specific_t specific_type, hid_t dxpl_id, void **req, va_list arguments)
{
    return H5VLattr_specific(unwrap(obj), loc_params, info->under_vol_id, specific_type, dxpl_id, req, arguments);
}
...
attr_optional(void *obj, H5VL_attr_optional_t opt_type, hid_t dxpl_id, void **req,
    va_list arguments)
{
    return H5VLattr_optional(unwrap(obj), info->under_vol_id, opt_type, dxpl_id, req, arguments);
}
...
{
    return H5VLattr_close(unwrap(attr), info->under_vol_id, dxpl_id, req);
}
