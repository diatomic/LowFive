...
{
    return H5VLintrospect_get_conn_cls(unwrap(obj), info->under_vol_id, lvl, conn_cls);
}
...
{
    return H5VLintrospect_opt_query(unwrap(obj), info->under_vol_id, cls, opt_type, supported);
}
